...
var api = module.exports = {
    ...
    */
    getNodeList: async function(opts) {
        return REDRegistry.getNodeList()
    },
    ...
    */
    getNodeConfigs: async function(opts) {
        return REDRegistry.getNodeConfigs(opts.lang)
    },
    ...
    */
    getIconList: async function(opts) {
        return REDRegistry.getNodeIcons();
    },
    /**
    * Gets a node icon
    * @param {Object} opts
    ...
    */
    getIcon: async function(opts) {
        var iconPath = REDRegistry.getNodeIconPath(opts.module,opts.icon) || __dirname+"/../../node_modules/@node-red/editor-client/public/red/images/icons/arrow-in.svg";
